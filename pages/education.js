    ...
    <>
      ...
      >
        ...
        <Text fontSize={["15px", "15px", "20px", "25px"]}>
          I'm currently graduating in BVRaju Institute of Technology located in
          Narsapur, Telangana. I majored in Computer Science Engineering , so
        ...
        <Text fontSize={["15px", "15px", "20px", "25px"]}>
          ...
          on my Mathematical skills. Physics and Chemistry were also where I've
          focused on too. Clearing JEE Mains, but couldnt quite cross the bar to
          enter any NITs. That said, qualified to write IITJEE, but couldn't
          able to crack it. I've also given TSEAMCET 2018 and secured a rank of
          ~7500. I never look back to things which I would have done better.
          Instead, focus on what ahead.
        </Text>
        <Divider borderTopWidth="2px" borderColor={"#e0847e"} mb="0px" />
        <Text fontSize={["22px", "44px"]} fontWeight="bold">
          Secondary
        ...
        <Text fontSize={["15px", "15px", "20px", "25px"]}>
          ...
          creatively all the time. The competition was too lively and It's been
          a great time studying in School.
        </Text>
      </Stack>
    </>
  );
